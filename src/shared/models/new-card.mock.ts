...
export const NEWS_MOCK: NewCardModel[] = [
    {
        ...
        textLarge: 'Por primera ves en Republica Dominicana.<br><br>@809expo Presentado por 100X35 Expo y Clean Culture, traen AutoShow / Drift / Caribbean Culture en un evento con @adam_lz y amigos.<br>br> El evento tendra lugar en el Autodromo de las Americas este Domingo 7 de Junio de 2026. Sera una experiencia de dia completo con seccion de Car Show, seccion de Drift, Vendor midway, entretenimiento en vivo y la premiacion de los mejores carros del evento.<br> Podras registrar tu vehiculo para el evento proximamente en: cleancultureevents.com',
    },
    {
        id: 2,
