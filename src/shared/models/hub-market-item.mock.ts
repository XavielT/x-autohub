import { HubMarketItemModel } from './hub-market-item.model';
...
export const HUB_MARKET_ITEMS_MOCK: HubMarketItemModel[] = [
  {
    ...
    //images 'assets/imgs/supra-white.jpg',
  ...
  },
  {
    ...
    images: ['assets/imgs/vw-golf-mk4.png'],
    price: 8000,
    location: 'Santiago',
  ...
  },
  {
    ...
    images: ['assets/imgs/citroen-c3.png'],
    price: 5000,
    location: 'La Romana',
    sellerName: 'Carlos R.',
    category: 'vehiculos',
  ...
  },
  {
    ...
    images: ['assets/imgs/catalog/accesorios.png'],
    price: 120,
